<?php include(ROOT . '/views/layouts/header.php');?>
	 <section class="bg-title-page flex-col-c-m effect7" style="background-image: url(/template/images/categories/21.jpg);">
			...
			<?php if(!isset($category) || $category==NULL){echo 'BLOG';}else{echo $blogCategories[$category-1]['name'];}?>
		</h2>
        </section>
				...
				<div class="col-md-8 col-lg-9 p-b-75">
					<div class="p-r-50 p-r-0-lg">
						...
						<div class="item-blog p-b-80">
							<a href="/article/<?php echo $articlesItem['id'];?>" class="item-blog-img pos-relative dis-block hov-img-zoom">
								<img src="/template/images/articles/<?php echo $articlesItem['id'];?>.jpg" alt="IMG-BLOG">

								<span class="item-blog-date dis-block flex-c-m pos1 size17 bg4 s-text1">
									<?php echo $articlesItem['date'];?>
								</span>
							</a>

							<div class="item-blog-txt p-t-33">
								<h4 class="p-b-11">
									<a href="/article/<?php echo $articlesItem['id'];?>" class="m-text24">
								...
								<div class="s-text8 flex-w flex-m p-b-21">
									<span>
										<?php echo $authors[$articlesItem['author_id']];?>
									...
									<span>
                                                                                <?php if(isset($comments[$articlesItem['id']])){echo $comments[$articlesItem['id']].' Comments';}else{echo '0  Comments';}?> 
								...
								<a href="/article/<?php echo $articlesItem['id'];?>" class="s-text20">
									Continue Reading
				...
				<div class="col-md-4 col-lg-3 p-b-75">
					<div class="rightbar">
						...
						<div class="pos-relative bo11 of-hidden">
							<input class="s-text7 size16 p-l-23 p-r-50" type="text" name="search_product" placeholder="Search">
						...
						<ul>
							...
							<li class="p-t-6 p-b-8 bo6">
								<a href="/blog/<?php echo $blogCategoryItem['id'];?>" class="s-text13 p-t-5 p-b-5">
